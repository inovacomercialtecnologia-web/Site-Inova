          ...
          {metrics.map((metric, i) => (
            ...
            >
              <div className="relative mb-6">
                <span className="text-[56px] md:text-[96px] font-black bg-gradient-to-r from-[#C9A84C] to-[#E5C05C] bg-clip-text text-transparent leading-none tracking-tighter block group-hover:scale-105 transition-transform duration-700">
                  {metric.value}
                </span>
