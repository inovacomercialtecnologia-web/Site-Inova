...
function DealDetailPanel({ deal, onClose }: { deal: Deal; onClose: () => void }) {
  ...
  return (
    <motion.div
      ...
      className="absolute right-0 top-0 h-full w-full sm:w-80 bg-white border-l border-slate-200 flex flex-col shadow-xl z-10 overflow-y-auto"
    >
...
function ClientesView({ clients, search, onSearch, segmentFilter, onSegmentChange }: {
  ...
  return (
    <div className="flex-1 overflow-hidden flex flex-col">
      {/* Filter bar */}
      <div className="px-3 md:px-6 py-3 border-b border-slate-100 flex flex-wrap items-center gap-3 bg-white shrink-0">
      ...
      {/* Table */}
      <div className="flex-1 overflow-y-auto overflow-x-auto px-3 md:px-6 py-4">
