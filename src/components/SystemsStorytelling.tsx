...
export default function SystemsStorytelling() {
  ...
  return (
    <section ref={containerRef} className="relative h-[600vh] bg-[#f5f3ee] w-full">
      <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
        ...
        {/* Cards Container */}
        <div className="relative w-full max-w-[680px] h-[400px] flex items-center justify-center pointer-events-none">
          
          {/* Card 1 */}
          <motion.div 
            className="absolute w-full bg-white rounded-[20px] p-10 pointer-events-auto"
            style={{ 
          ...
          >
            ...
            <h3 className="text-[#c9a84c] text-[22px] font-bold mb-4">{systems[0].title}</h3>
            <p className="text-[#4a4a4a] text-[15px] leading-[1.7]">{systems[0].desc}</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-[#c9a84c] text-[22px] font-bold mb-4">{systems[1].title}</h3>
            <p className="text-[#4a4a4a] text-[15px] leading-[1.7]">{systems[1].desc}</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-[#c9a84c] text-[22px] font-bold mb-4">{systems[2].title}</h3>
            <p className="text-[#4a4a4a] text-[15px] leading-[1.7]">{systems[2].desc}</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-[#c9a84c] text-[22px] font-bold mb-4">{systems[3].title}</h3>
            <p className="text-[#4a4a4a] text-[15px] leading-[1.7]">{systems[3].desc}</p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-[#c9a84c] text-[22px] font-bold mb-4">{systems[4].title}</h3>
            <p className="text-[#4a4a4a] text-[15px] leading-[1.7]">{systems[4].desc}</p>
          </motion.div>
