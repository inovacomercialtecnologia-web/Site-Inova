...
export default function Navbar() {
  ...
  // Text color logic: 
  // If transparent and on a white page, use black text.
  ...
  const hoverBorderColor = isDarkText ? 'border-black' : 'border-[#C9A84C]';
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <Link 
              ...
              className={`hidden sm:block border ${borderColor} hover:${hoverBorderColor} ${textColor} text-[11px] font-medium tracking-[0.2em] px-10 py-3.5 rounded-full transition-all ${hoverBg} uppercase`}
            >
              Contato
            </Link>
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div 
            ...
            className="fixed inset-0 z-[60] bg-[#000000] flex flex-col p-8"
          >
