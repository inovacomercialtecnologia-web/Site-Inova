  ...
  return (
    <div className="min-h-screen bg-[#080808] text-[#FAFAF8] font-sans pt-32 pb-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-[800px] mx-auto">
        ...
        <h1 className="text-4xl font-light tracking-tight mb-8">Política de Cookies</h1>
        <div className="text-white/60 font-light leading-relaxed space-y-6">
          <p>Esta página está em construção. Em breve a Política de Cookies completa da Inova Systems Solutions estará disponível aqui.</p>
